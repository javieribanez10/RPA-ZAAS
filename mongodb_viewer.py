...
Permite explorar y analizar los reportes contables almacenados.
"""
...
st.set_page_config(
    page_title="MongoDB Viewer - Reportes Nubox",
    page_icon="📊",
    layout="wide",
...
def main():
    ...
    # Controles de la barra lateral (que crean los filtros globales)
    view_mode = sidebar_controls()
